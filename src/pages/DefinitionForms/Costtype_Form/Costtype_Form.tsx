...
function Costtype_Form({onSave,selectRow,formType}:any){
  ...
  useEffect(() => { 
    if(selectRow && formType=='Edit'){
      // apiService.Get_CosttypesGetById(selectRow?.id)
      // .then((response:any) => {
  ...
  function onSubmitProject(e:any){
    ...
    if(formType=='Edit'){
      ...
      apiService.Edit_Costtypes(data)        
      .then((response:any) => {
      ...
      apiService.Create_Costtypes(data)        
      .then((response:any) => {
